...
{<h1 className="text-center font-extrabold md:text-5xl mt-8">Solid Table</h1>}

<Bleed><Features/></Bleed>

Solid Table is a collection of hooks for **building powerful tables and datagrid experiences**. These hooks are lightweight, composable, and ultra-extensible, but **do not render any markup or styles for you**. This effectively means that React Table is a "headless" UI library
